                    ...
                    <div className="col-lg-10">
                      <div className="cont">
                        <div className="spacial">
                          <p>
                          Our pedagogical approach heavily influenced the design of our residential school campus. We prioritized flexibility in space design to accommodate various teaching methods, fostering collaborative learning and student interaction. This environment is essential for nurturing creativity and encouraging the blossoming of innovative ideas.
                          </p>
          ...
          <div className="tex-bg">Work</div>
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="mb-10">
                              <img src="/assets/img/Architectures/projects/school1.jpg" alt=""/>
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="mb-10">
                              <img src="/assets/img/Architectures/projects/school4.jpg" alt=""/>
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="mb-10">
                              <img src="/assets/img/Architectures/projects/school3.jpg" alt="" />
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="mb-10">
                              <img src="/assets/img/Architectures/projects/school6.jpg" alt="" />
                            </div>
                          </div>
                        </div>
                        {/* <p>
